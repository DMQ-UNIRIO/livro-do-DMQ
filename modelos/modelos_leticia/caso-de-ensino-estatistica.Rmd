...
Depois disso uma etapa importante é inspecionar os dados. Isso pode ser facilmente observado no R com a função *str*.

```{r, eval=FALSE}
str(banco_de_dados)
```
 
Aqui, os alunxs devem perceber que há um erro no banco de dados. Temos variáveis qualitativas sendo tratadas como quantitativas. para corrigí-las devemos usar uma das duas estratégias abaixo.
